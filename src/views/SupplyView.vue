            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class='row'>
                            <div class="col-md-7" id="chart1-div" style="overflow: hidden;">

                                <h6> Number of Employees vs PPI (base=100, 2012)</h6>
                                <svg id="doubleLineChart" width="100%" height="100%"></svg>

                            </div>

                            <div class="col-md-5" id="chart2-div" style="overflow: hidden;">
...
export default {
  ...
  mounted: function () {
    ...
    var width = document.getElementById("chart1-div").clientWidth - margin.left - margin.right;
    var height = document.getElementById("chart1-div").clientHeight - margin.top - margin.bottom;
...
/* Style the bars */
.men-arc {
    fill: #66b3ff; /* Blue for UK */
}

/* Style the US bars */
.women-arc {
    fill: #ff9999; /* Red for US */
}
